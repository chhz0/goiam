...
func Test_SplitTerms(t *testing.T) {
...
func Test_SplitTerm(t *testing.T) {
...
func Test_SelectorParse(t *testing.T) {
...
func Test_DeterministicParse(t *testing.T) {
...
func Test_OneTermEqualSelector(t *testing.T) {
...
func Test_SetMatches(t *testing.T) {
	labelset := Set{
		"foo": "bar",
		"baz": "blah",
	}
...
func Test_NilMapIsValid(t *testing.T) {
...
func Test_SetIsEmpty(t *testing.T) {
...
func Test_RequiresExactMatch(t *testing.T) {
	testCases := map[string]struct {
		S     Selector
		Label string
		Value string
